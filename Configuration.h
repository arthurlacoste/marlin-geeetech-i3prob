...
#define STRING_CONFIG_H_AUTHOR "(geeetech, I3 config, Arthur Lacoste edit)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,100}  // MXL, Z M8=1.25, MK8 // 93 edited at 100. AL
