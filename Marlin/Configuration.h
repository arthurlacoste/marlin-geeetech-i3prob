...
#define STRING_CONFIG_H_AUTHOR "(Hidius, 1.1.8 20180121)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gee Pi3 Pro B"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  //////#define  DEFAULT_Kp 49.51
  //////#define  DEFAULT_Ki 4.41
  //////#define  DEFAULT_Kd 138.92
